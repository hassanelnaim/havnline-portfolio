import { Users, UserCheck, DollarSign, TrendingUp, PhoneCall } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="rounded-2xl border border-border bg-card p-5 shadow-card">
          <div className="flex items-center justify-between"><span className="text-[11px] font-semibold uppercase tracking-wide text-text-faint">Calls made</span><PhoneCall className="h-4 w-4 text-brand" /></div>
