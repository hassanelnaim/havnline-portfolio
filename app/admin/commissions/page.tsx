  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-border bg-card p-5 shadow-card"><div className="text-[11px] font-semibold uppercase tracking-wide text-text-faint">Total pending</div><div className="mt-2 font-display text-[28px] font-semibold text-warning">{formatCurrency(pending)}</div></div>
        <div className="rounded-2xl border border-border bg-card p-5 shadow-card"><div className="text-[11px] font-semibold uppercase tracking-wide text-text-faint">Total paid</div><div className="mt-2 font-display text-[28px] font-semibold text-success">{formatCurrency(paid)}</div></div>
      </div>
